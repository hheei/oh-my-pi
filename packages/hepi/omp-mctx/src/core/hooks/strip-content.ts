...
/** Newest assistant that is visible in the provider replay. */
...
export function stripReasoningFromMergedAssistants(
	...
	const mutationExempt = findLatestAssistantReasoningMutationExemptMessage(messages);
