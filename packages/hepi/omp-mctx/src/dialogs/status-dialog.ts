...
import { estimatePiPrefixTokens, resolvePiContextUsage } from "#host/pi-ext-shim";
...
export function buildPiStatusDetail(
	...
	const resolved = resolvePiContextUsage({
		live: usage,
		contextWindow: typeof ctx.model?.contextWindow === "number" ? ctx.model.contextWindow : undefined,
		prefixTokens:
