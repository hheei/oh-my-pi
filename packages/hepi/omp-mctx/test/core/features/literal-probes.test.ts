...
import {
	containsProbeVerbatim,
	extractLiteralProbes,
} from "../../../src/core/features/literal-probes";
...
describe("extractLiteralProbes", () => {
	...
	it("deduplicates case-insensitively and caps at five", () => {
		const probes = extractLiteralProbes("ctx-status ctx-status foo-bar baz-qux a-b c-d e-f g-h");
