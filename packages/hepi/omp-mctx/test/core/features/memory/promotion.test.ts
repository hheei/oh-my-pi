...
vi.mock("../../../../src/core/features/project-embedding-registry", async (importOriginal) => {
	const realEmbedding =
		await importOriginal<
			typeof import("../../../../src/core/features/project-embedding-registry")
		>();
	return {
		...realEmbedding,
...
const { embedPromotedFacts, promoteSessionFactsDurable } = await import(
	"../../../../src/core/features/memory/promotion"
);
